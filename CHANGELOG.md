...
### Fixed
- Prevent opening duplicate windows for the same file

## [1.0.36] - 2026-04-10

### Changed
- Sidebar now collapsed by default, users control visibility manually

## [1.0.35] - 2026-04-10

### Fixed
- Fix content centering by ensuring NSHostingView fills content area

## [1.0.34] - 2026-04-09

### Changed
- Increase auto-restore threshold to 1800 for sidebar

## [1.0.33] - 2026-04-09

### Added
- Code block copy button with localization support (Copy/复制, Copied!/已复制!)
- Link URL tooltip on hover
...
### Fixed
- Enforce window minimum size 800x600 using NSWindowDelegate
- Show/hide sidebar based on current window width when opening new document

## [1.0.31] - 2026-04-09

### Added
- Auto-collapse sidebar when window width < 1051px
- Auto-restore sidebar when window width >= 1200px or when opening new document

## [1.0.30] - 2026-04-09

### Added
- Auto-collapse sidebar when window width < 800px

## [1.0.29] - 2026-04-09

### Fixed
- Fix content centering (add alignment to ZStack and MarkdownWebView)

## [1.0.28] - 2026-04-09

### Fixed
- Fix content centering and clipping behavior

## [1.0.27] - 2026-04-09

### Fixed
- Fix content clipping when resizing window

## [1.0.26] - 2026-04-09

### Fixed
- Fix toolbar icons becoming disabled when opening files
